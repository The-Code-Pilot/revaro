...
const JOURNEYS: Record<CancelReason, JourneyConfig> = {
  "Too expensive": {
    ...
    offerVisual: (
      <div className="mb-5 rounded-lg border border-dashed border-emerald-300/50 bg-emerald-50/50 p-4">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-emerald-900">Pro plan</span>
          <span className="rounded-full bg-emerald-100 px-2 py-0.5 text-xs font-bold text-emerald-700">-25%</span>
        </div>
        <div className="mt-2 flex items-baseline gap-2">
          <span className="font-mono text-2xl font-bold text-emerald-900">$66.75</span>
          <span className="text-sm text-emerald-700/60 line-through">$89.00</span>
          <span className="text-xs text-emerald-700/60">/mo</span>
        </div>
        <p className="mt-1 text-xs text-emerald-700/70">For 3 months, then $89/mo</p>
      </div>
    ),
  },
  "Missing feature": {
    ...
    offerVisual: (
      <div className="mb-5 rounded-lg border border-blue-200/60 bg-blue-50/50 p-4">
        <div className="flex items-center gap-2">
          <CalendarDays className="size-4 text-blue-600" />
          <span className="text-sm font-semibold text-blue-900">Feature waitlist</span>
        </div>
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-2">
            <Check className="size-3.5 text-blue-500" />
            <span className="text-xs text-blue-800/80">Early access 2 weeks before public</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="size-3.5 text-blue-500" />
            <span className="text-xs text-blue-800/80">Direct line to product team</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="size-3.5 text-blue-500" />
            <span className="text-xs text-blue-800/80">Ships estimated March 2025</span>
          </div>
        </div>
      </div>
    ),
  ...
  "Not using it enough": {
    ...
    offerVisual: (
      <div className="mb-5 rounded-lg border border-amber-200/60 bg-amber-50/50 p-4">
        <div className="flex items-center gap-2">
          <Pause className="size-4 text-amber-600" />
          <span className="text-sm font-semibold text-amber-900">30-day pause</span>
        </div>
        <div className="mt-3 grid grid-cols-2 gap-3">
          <div className="rounded-md bg-white/60 p-2.5">
            <p className="text-xs font-medium text-amber-900/70">No charge</p>
            <p className="mt-0.5 text-xs text-amber-800/60">$0 for 30 days</p>
          </div>
          <div className="rounded-md bg-white/60 p-2.5">
            <p className="text-xs font-medium text-amber-900/70">Data kept</p>
            <p className="mt-0.5 text-xs text-amber-800/60">Everything saved</p>
          </div>
        </div>
      </div>
    ),
  ...
  "Switching to another product": {
    ...
    offerVisual: (
      <div className="mb-5 rounded-lg border border-violet-200/60 bg-violet-50/50 p-4">
        <div className="flex items-center gap-2">
          <Phone className="size-4 text-violet-600" />
          <span className="text-sm font-semibold text-violet-900">10-minute comparison</span>
        </div>
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-2">
            <Check className="size-3.5 text-violet-500" />
            <span className="text-xs text-violet-800/80">Feature-by-feature comparison</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="size-3.5 text-violet-500" />
            <span className="text-xs text-violet-800/80">Migration assistance if you switch</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="size-3.5 text-violet-500" />
            <span className="text-xs text-violet-800/80">No sales pressure, just facts</span>
          </div>
        </div>
      </div>
    ),
  ...
  Other: {
    ...
    offerVisual: (
      <div className="mb-5 rounded-lg border border-slate-200/60 bg-slate-50/50 p-4">
        <div className="flex items-center gap-2">
          <MessageSquare className="size-4 text-slate-600" />
          <span className="text-sm font-semibold text-slate-900">Quick feedback</span>
        </div>
        <div className="mt-3 space-y-1.5">
          <div className="h-2 w-full rounded-full bg-slate-200/60" />
          <div className="h-2 w-4/5 rounded-full bg-slate-200/60" />
          <div className="h-2 w-3/5 rounded-full bg-slate-200/60" />
        </div>
        <p className="mt-2 text-xs text-slate-600/70">Optional. Skip any question.</p>
      </div>
    ),
  },
};
...
const MemoizedRescueDemo = memo(function RescueDemo({
  ...
  return (
    <div className="relative rounded-xl border border-border/70 bg-surface/40 p-1.5 shadow-lg shadow-black/10 backdrop-blur-sm">
      <div className="overflow-hidden rounded-lg border border-border/50 bg-background">
          ...
          {step === "idle" && (
            <div className="w-full max-w-xs text-center">
              <div className="mx-auto mb-5 flex size-14 items-center justify-center rounded-2xl bg-surface-2">
                <BarChart3 className="size-7 text-muted-foreground/60" aria-hidden="true" />
              </div>
              <p className="text-sm font-medium text-muted-foreground/80">Pro plan</p>
              <p className="mt-1.5 font-mono text-4xl font-bold tracking-tight text-foreground">
                $89
                <span className="text-lg font-normal text-muted-foreground/50">
                  /mo
                </span>
              </p>
              <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-success/8 px-3 py-1 text-xs font-semibold text-success">
              ...
              <button
                ...
                className="mt-8 inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground/70 underline decoration-border underline-offset-4 transition-colors hover:text-foreground"
              >
                Cancel subscription
          ...
          {step === "reason" && (
            <div className="w-full max-w-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="hidden shrink-0 rounded-full bg-accent/8 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-accent sm:block">
                  5 flows
                </span>
              </div>
              ...
              <fieldset className="mt-6 space-y-2">
                ...
                {CANCEL_REASONS.map((r) => (
                  <label
                    key={r}
                    className={cn(
                      "group flex cursor-pointer items-center gap-3 rounded-lg border px-4 py-3.5 text-left text-sm transition-all duration-200 focus-within:ring-2 focus-within:ring-accent/40 focus-within:ring-offset-2 focus-within:ring-offset-background",
                      reason === r
                        ? "border-accent/40 bg-accent/[0.04] text-foreground shadow-sm"
                        : "border-border/50 text-muted-foreground/80 hover:border-border hover:bg-surface/20 hover:text-foreground"
                    )}
                  >
                    <input
                      type="radio"
                    ...
                    {reason === r && (
                      <ChevronRight className="size-3.5 text-accent/60" aria-hidden="true" />
                    )}
                  </label>
                ))}
              </fieldset>
              <button
                ...
                className="mt-6 inline-flex h-11 w-full items-center justify-center rounded-lg bg-accent px-4 text-sm font-semibold text-accent-foreground transition-all duration-200 hover:bg-accent-2 hover:shadow-md hover:shadow-accent/15 active:scale-[0.98]"
              >
                Continue
            ...
            <div className="w-full max-w-sm">
              ...
              <div className="mt-6 flex flex-col items-center gap-3">
                <button
                  type="button"
                  onClick={handleSave}
                  className="inline-flex h-11 w-full items-center justify-center rounded-lg bg-accent px-4 text-sm font-semibold text-accent-foreground transition-all duration-200 hover:bg-accent-2 hover:shadow-md hover:shadow-accent/15 active:scale-[0.98]"
                >
          ...
          {step === "saved" && (
            <div className="w-full max-w-sm text-center">
              ...
              <button
                ...
                className="mt-7 inline-flex items-center gap-1.5 text-xs font-medium text-muted-foreground/60 underline underline-offset-4 transition-colors hover:text-foreground"
              >
        ...
        {/* Step Progress */}
        <div className="flex items-center justify-center gap-1 border-t border-border/50 px-5 py-3">
          {[0, 1, 2, 3, 4].map((i) => {
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isActive ? "w-5 bg-accent" : isPast ? "w-2 bg-accent/40" : "w-2 bg-border"
                )}
                aria-hidden="true"
              />
            );
...
const MemoizedDashboard = memo(function Dashboard({
  ...
  return (
    <div className="relative rounded-xl border border-border/70 bg-surface/40 p-1.5 shadow-lg shadow-black/10 backdrop-blur-sm">
      <div className="overflow-hidden rounded-lg border border-border/50 bg-background">
        {/* Dashboard Header */}
        <div className="flex items-center justify-between border-b border-border/50 px-4 py-3.5 sm:px-5">
          <div className="flex items-center gap-5">
            ...
            <span className="hidden text-sm font-medium text-muted-foreground/50 transition-colors hover:text-muted-foreground sm:inline cursor-pointer">
              Flows
            </span>
            <span className="hidden text-sm font-medium text-muted-foreground/50 transition-colors hover:text-muted-foreground sm:inline cursor-pointer">
              Analytics
          ...
          <div className="flex items-center gap-2">
            <Clock className="size-3.5 text-muted-foreground/40" aria-hidden="true" />
            <span className="text-xs font-semibold text-muted-foreground/50">Last 30 days</span>
          </div>
        </div>
        ...
        <div className="grid gap-px bg-border/30 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div
            className={cn(
              ...
              isHighlighted && "ring-1 ring-inset ring-emerald-500/15 bg-emerald-50/[0.02]"
            )}
          >
            <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="mt-2 text-xs font-medium text-muted-foreground/50">
              {data.offersTotal}
            </span>
          </div>
              ...
              <div className="relative flex size-12 shrink-0 items-center justify-center">
                <svg viewBox="0 0 48 48" className="size-12 -rotate-90" aria-hidden="true">
                  ...
                  <circle
                    ...
                    className={cn("transition-all duration-700", isHighlighted && "stroke-emerald-500")}
                  />
                </svg>
        ...
        <div className="grid gap-px bg-border/30 lg:grid-cols-3">
          ...
          <div className="bg-background p-5 sm:p-6 lg:col-span-2">
            <div className="mb-5 flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-foreground">Revenue recovered</h3>
                <p className="mt-0.5 text-xs font-medium text-muted-foreground/40">
                  Monthly trend, last 6 months
                </p>
              </div>
              <span className="flex items-center gap-1 rounded-full bg-success/8 px-2.5 py-1 text-xs font-bold text-success">
            ...
            <div className="mt-3 flex justify-between text-xs font-bold text-muted-foreground/40">
              {months.map((m) => (
                <span key={m}>{m}</span>
              ))}
            </div>
              ...
              {reasons.map((r) => (
                <div key={r.label}>
                  <div className="mb-1.5 flex justify-between text-xs">
                    <span className="font-medium text-muted-foreground/70">{r.label}</span>
            ...
            {data.activity.map((a) => (
              <div
                ...
                className={cn(
                  ...
                  a.name === "You" ? "bg-accent/[0.03]" : "hover:bg-surface/20"
                )}
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <span className="text-sm truncate">
                    ...
                    <span className="text-muted-foreground/60">{a.action}</span>
                  </span>
                </div>
                <span className="flex shrink-0 items-center gap-1 text-xs font-medium text-muted-foreground/40">
      ...
      <Container>
        ...
        <div className="mx-auto mt-12 max-w-lg">
          ...
          <div className="mt-5 flex flex-col items-center gap-2">
            <p className="flex items-center justify-center gap-2 text-center text-xs font-medium text-muted-foreground/60">
              <ShieldCheck className="size-3.5 shrink-0 text-accent/60" aria-hidden="true" />
        ...
        <p className="mt-16 text-center text-sm font-medium text-muted-foreground/60">
